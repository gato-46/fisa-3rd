 ...
 *  			정수 0/실수 0.0/boolean false/char 'u000'/참조 null
 *  * 로컬 변수 : stack 메모리에 생성, 자동 초기화 안됨
 *  			로컬 변수는 선언시 기본값으로라도 초기화 설정
...
//		m1();
		...
		//getPeople 값 : model.domain.PeopleDTO@5700d6b1 - 객체 , .getName()을 통해 객체의 이름을 가져와야 한다!
	}
}
