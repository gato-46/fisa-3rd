 ...
 * 	- 상수, 미완성 메소드, 주석
 * 3. 주 용도
 * 	- 반드시 하위 클래스 개발해서 미완성 메소드 재정의 필수로 제시
 * 4. 주 목적
 * 	- 모든 개발자들의 코드 표준화, 벤더사는 상이하나 하나의 웹소스가 웹서버에서 동일한 구조로 실행
 * 	
 * 
 */
...
//기능 없이 메소드 선언만 제시(스펙)
interface Calc { 
	//public abstact int calc(int v1, int v2); 미완성 메소드란 뜻
...
public class LevelUp3 {
	public static void main(String [] args) {
		...
		//step01
		//해결책 - 미완성 메소드 제정의하는 하위 클래스 개발 및 객체 생성
		 ...
		 */
		//step03 - 람다식에 적합한 inferface와 다양한 연산식 활용 연습
		//Calc2 interface 사용
		/* (v1,v2) - 값을 받고자 하는 선언
		 ...
		 * 
		 */
		// Calc2 cc1 = (v1,v2) -> {return v1+v2}; {} return 키워드 생략 불가
		...
		// v1과 v2 더한 결과 출력하고 반환값은 빼기로 반환하기 {} - 기능을 여러개 쓸때
		cc1 = (v1,v2) -> { 
